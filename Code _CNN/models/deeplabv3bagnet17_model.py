# backbone taken from https://github.com/wielandbrendel/bag-of-local-features-models/blob/master/bagnets/pytorchnet.py
...
def deeplabv3_bagnet17(
    ...
    **kwargs: Any,
    ...
    backbone = bagnet17()
    model = _deeplabv3_bagnet17(backbone, num_classes, aux_loss)
...
class Deeplabv3Bagnet17Model(BaseModel):
    """ Deeplabv3 with BagNet backbone with adaptable input channel number
        https://github.com/wielandbrendel/bag-of-local-features-models/blob/master/bagnets/pytorchnet.py
    """
    def __init__(self, config, in_channels):
        BaseModel.__init__(self, config)
        # define network
        self.net = deeplabv3_bagnet17(
            weights=None, num_classes=config.num_classes, weights_backbone=None)

        self.net.backbone.conv1 = nn.Conv2d(in_channels, 64, kernel_size=1, stride=1, padding=0,
                                             bias=False)
