...
def deeplabv3_bagnet9(
    ...
    **kwargs: Any,
    ...
    backbone = bagnet9()
    model = _deeplabv3_bagnet9(backbone, num_classes, aux_loss)
...
class Deeplabv3Bagnet9Model(BaseModel):
